...
private String post_key,user_key;
    private TextView userName,userProfilename,userStatus,userCountry,userDob,userGender,user_relationship;
    private CircleImageView userProfileImage;
    private DatabaseReference userRef,vistRef;
    private String current_user_id;
    private FirebaseAuth mAuth;
    private Button SendFriendRequestButton,declineFriendRequestButton;
    private String receiver_user_id,sender_user_id;
    private String CURRUNT_STATE;
    private DatabaseReference FriendsReference,postRef,NotificationReference,FriendRequestReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        post_key=getIntent().getExtras().getString("postkey").toString();

        userRef=FirebaseDatabase.getInstance().getReference().child("posts").child(post_key);
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                receiver_user_id=dataSnapshot.child("uid").getValue().toString();
                ...
                Query mypost=postRef.orderByChild("uid").startAt(receiver_user_id).endAt(receiver_user_id+"\uf8ff");
