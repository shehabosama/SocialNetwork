...
import com.example.shehab.socialnetwork.utils.SpacesItemDecoration;
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (bitmap == null) {
                    thumbImage = BitmapUtils.getBitmapFromAssets(getActivity(), MainActivity2.IMAGE_NAME, 100, 100);
                } else {
